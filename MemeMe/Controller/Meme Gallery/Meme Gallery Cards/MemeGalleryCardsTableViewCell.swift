//
//  MemeGalleryCardsTableViewCell.swift
//  MemeMe
//
//  Created by Jase-Omeileo West on 12/23/17.
...
class MemeGalleryCardsTableViewCell: UITableViewCell
{
    ...
    @IBOutlet weak var memeCaptionBottomView: UIView!
    @IBOutlet weak var memeCaptionBottomText: UILabel!
}
